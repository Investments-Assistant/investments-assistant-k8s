module "waf" {
  source           = "git::ssh://git@github.com/Investments-Assistant/opentofu-modules.git//waf?ref=v1.0.0"
  allowed_ip_cidrs = var.allowed_ip_cidrs
}

module "acm" {
  source = "git::ssh://git@github.com/Investments-Assistant/opentofu-modules.git//acm?ref=v1.0.0"
...
module "cognito" {
  count      = var.enable_cognito_auth ? 1 : 0
  source     = "git::ssh://git@github.com/Investments-Assistant/opentofu-modules.git//cognito?ref=v1.0.0"
