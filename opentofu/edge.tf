module "waf" {
  source           = "git::ssh://git@github.com/Investments-Assistant/opentofu-modules.git//waf?ref=v0.0.1"
  allowed_ip_cidrs = var.allowed_ip_cidrs
}

module "acm" {
  source = "git::ssh://git@github.com/Investments-Assistant/opentofu-modules.git//acm?ref=v0.0.1"
